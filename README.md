...
![Version: 3.2.1-bb.1](https://img.shields.io/badge/Version-3.2.1--bb.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.6.1](https://img.shields.io/badge/AppVersion-2.6.1-informational?style=flat-square)
...
| kubectlImage.tag | string | `"v1.25.2"` | Overrides the image tag whose default is the chart's appVersion |
