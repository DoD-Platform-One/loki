...
![Version: 5.23.1-bb.0](https://img.shields.io/badge/Version-5.23.1--bb.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.9.1](https://img.shields.io/badge/AppVersion-2.9.1-informational?style=flat-square)
...
| kubectlImage.tag | string | `"1.27.6"` | Overrides the image tag whose default is the chart's appVersion |
...
| loki.image.tag | string | `"2.9.1"` | Overrides the image tag whose default is the chart's appVersion |
